...
class Order extends CI_Controller{
	...
	public function createOrder(){
		...
		$insertOrderData=array_combine($req['ids'],$req['values']);	
		$insertOrderData['owner']=$req['owner'];
		$insertOrderData['order_processer']=$req['reciever'];
		$insertOrderData['dead_line']=$req['lastTime'];
		$insertOrderData['order_ctime']=date("Y-m-d H:i:s");
		$insertOrderData['client_id']=$req['client_id'];
	...
	public function ajaxOrderLookByOwner(){
		...
		$aColumns=array("id","owner","order_ctime","order_processer","order_status","order_note","id");
