...
sum(case call_type when 'callin' then 1 else 0 end) as sumCallin";
	...
	function ajaxReportCommunicate(){	
		...
		$aColumns = array('agent','name','phone_number', 'phone_number_name','call_type' ,'status' ,'link_stime','call_times', 'inqueue_wait_times','location');	
		...
		$fields="agent,name,phone_number,'' as phone_number_name,call_type,status,link_stime,call_times,inqueue_wait_times,location";
		$sQuery = "
