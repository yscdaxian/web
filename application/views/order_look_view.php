	...
	createTables=function (filterString){
		$('#dataList').dataTable( {
			...
			"fnCreatedRow": function( nRow, aData, iDataIndex ) {	
			 	var htmlStr='<center><a href="javascript:onProcessOrder(\''+aData[0]+'\')"><img src="www/images/dxzx.png"></img></a></center>';
				
			 	$('td:eq(6)', nRow).html(htmlStr);
			},
			"sAjaxSource": "<?php echo site_url('order/ajaxOrderLookByOwner')?>",
			"oLanguage": {
     ...
     <div id="example" style='display:block'>
          <table width="100%" cellpadding="0" cellspacing="0" border="0"  id="dataList" >
          	<thead>       
            		<tr>      
						<th align="left">编号</th>
                        <th align="left">生成人</th>
                        <th align="left">生成时间</th>
                        <th align="left">处理人</th>
                        <th align="left">状态</th>
                        <th align="left">说明</th>
            			<th align="left">工单详情</th>
                    </tr>                    
            </thead>
            <tbody></tbody>	
          </table>
