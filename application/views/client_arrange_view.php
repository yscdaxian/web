...
$(document).ready(function() {
	...
	createTables=function (filterString){
		$('#dataList').dataTable( {
			...
			"sAjaxSource": "<?php echo site_url('client/ajaxArrangeClientLook')?>",
			"oLanguage": {
...
<div class="page_main page_tops">
    ...
    <div class="func-panel">
			 ...
			 <div align='right' class="right">
				 <input  type="button" name="btnSearch" value="添加" class="btnAdd" onClick="javascript:location.href= '<?php echo site_url("client/add")."/".$agentId?>'"/>&nbsp;
			 </div>		
   ...
   <div id="example" style='display:block'>
          <table width="100%" cellpadding="0" cellspacing="0" border="0"  id="dataList" >
          		<thead>
                    ...
                    <th align="left" width="100px">电话</th>
                    <th align="left">地址</th>    
